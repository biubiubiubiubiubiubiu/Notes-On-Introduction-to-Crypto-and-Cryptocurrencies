...
public class ValidationLists<E> {
	...
	private ValidationLists(final List<E> valid, final List<E> invalid, final List<E> conflicted) {
		super();
		this.valid = Collections.unmodifiableList( new ArrayList<E>(valid));
		this.invalid = Collections.unmodifiableList(new ArrayList<E>(invalid));
		this.conflicted = Collections.unmodifiableList(new ArrayList<E>(conflicted));
	}
	...
	public List<E> allElements() {
		final ArrayList<E> list = new ArrayList<E>(valid);
		list.addAll(invalid);
		return list;
	}
	...
	public static final class Builder<E>{
		...
		ValidationLists<E> build() {
			return new ValidationLists<E>(valid, invalid, conflicted);
		}
